...
function App() {
    return (
        <>
            ...
            <Services />
            <Feedback imageURL={data.imageURL} ratingImage={data.ratingImage} text={data.text} name={data.name} profession={data.profession} altAvatar={data.altAvatar} altRating={data.altRating} />
        </>
    );
}
